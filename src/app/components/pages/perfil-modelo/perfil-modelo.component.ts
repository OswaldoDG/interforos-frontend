...
@Component({
  selector: 'app-perfil-modelo',
  templateUrl: './perfil-modelo.component.html',
  styleUrls: ['./perfil-modelo.component.scss']
})
export class PerfilModeloComponent implements OnInit {
