...
export interface IPersonaClient {
     ...
     * @return Success
     */
    avatarPost(body: string | undefined): Observable<void>;
    /**
     * @return Success
     */
    avatarGet(usuarioId: string): Observable<string>;
}
...
export class PersonaClient implements IPersonaClient {
     ...
     * @return Success
     */
    avatarPost(body: string | undefined, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/persona/avatar";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAvatarPost(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    avatarGet(usuarioId: string, httpContext?: HttpContext): Observable<string> {
        let url_ = this.baseUrl + "/persona/avatar/{UsuarioId}";
        if (usuarioId === undefined || usuarioId === null)
            throw new Error("The parameter 'usuarioId' must be defined.");
        url_ = url_.replace("{UsuarioId}", encodeURIComponent("" + usuarioId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAvatarGet(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
