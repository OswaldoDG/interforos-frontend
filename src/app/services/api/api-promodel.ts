...
export interface ICastingClient {
     ...
     * @return OK
     */
    procesarmedios(id: string): Observable<Casting>;
    /**
     * @return OK
     */
     ...
     * @return OK
     */
    logoGet(castingId: string, tipoLogo: TipoLogoCasting): Observable<string>;
    /**
     * @param body (optional)
     * @return OK
     */
    logoPut(castingId: string, tipoLogo: TipoLogoCasting, body: string | undefined): Observable<void>;
    /**
     * @param body (optional)
     * @return OK
     */
     ...
     * @return OK
     */
    modeloPut(castingId: string, modeloId: string, categoriaId: string): Observable<ModeloCastingReview>;
    /**
     * @return OK
     */
     ...
     * @return OK
     */
    medios(castingId: string, modeloId: string, categoriaId: string): Observable<ModeloCasting>;
    /**
     * @return OK
     */
    modelos(castingId: string, categoriaId: string): Observable<Persona[]>;
    /**
     * @param formato (optional)
     * @return OK
     */
    excel(castingId: string, formato: string | undefined): Observable<void>;
    /**
     * @param formato (optional)
     * @return OK
     */
    lista(castingId: string, formato: string | undefined): Observable<void>;
}
...
export class CastingClient implements ICastingClient {
     ...
     * @return OK
     */
    procesarmedios(id: string, httpContext?: HttpContext): Observable<Casting> {
        let url_ = this.baseUrl + "/api/Casting/procesarmedios/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processProcesarmedios(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processProcesarmedios(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Casting>;
                }
            } else
    ...
    protected processProcesarmedios(response: HttpResponseBase): Observable<Casting> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    logoGet(castingId: string, tipoLogo: TipoLogoCasting, httpContext?: HttpContext): Observable<string> {
        let url_ = this.baseUrl + "/api/Casting/{CastingId}/logo/{TipoLogo}";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{CastingId}", encodeURIComponent("" + castingId));
        if (tipoLogo === undefined || tipoLogo === null)
            throw new Error("The parameter 'tipoLogo' must be defined.");
        url_ = url_.replace("{TipoLogo}", encodeURIComponent("" + tipoLogo));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    logoPut(castingId: string, tipoLogo: TipoLogoCasting, body: string | undefined, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Casting/{castingId}/logo/{TipoLogo}";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{castingId}", encodeURIComponent("" + castingId));
     ...
     * @return OK
     */
    modeloPut(castingId: string, modeloId: string, categoriaId: string, httpContext?: HttpContext): Observable<ModeloCastingReview> {
    ...
    protected processModeloPut(response: HttpResponseBase): Observable<ModeloCastingReview> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    medios(castingId: string, modeloId: string, categoriaId: string, httpContext?: HttpContext): Observable<ModeloCasting> {
        let url_ = this.baseUrl + "/api/Casting/{castingId}/categoria/{categoriaId}/modelo/{modeloId}/medios";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{castingId}", encodeURIComponent("" + castingId));
        if (modeloId === undefined || modeloId === null)
    ...
    protected processMedios(response: HttpResponseBase): Observable<ModeloCasting> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    excel(castingId: string, formato: string | undefined, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Casting/{CastingId}/excel?";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{CastingId}", encodeURIComponent("" + castingId));
        if (formato === null)
            throw new Error("The parameter 'formato' cannot be null.");
        else if (formato !== undefined)
            url_ += "formato=" + encodeURIComponent("" + formato) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    lista(castingId: string, formato: string | undefined, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Casting/{CastingId}/excel/lista?";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{CastingId}", encodeURIComponent("" + castingId));
        if (formato === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLista(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLista(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processLista(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IClientesClient {
     ...
     * @return OK
     */
    faltantes(id: string): Observable<void>;
    /**
     * @return OK
     */
...
export class ClientesClient implements IClientesClient {
     ...
     * @return OK
     */
    faltantes(id: string, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/clientes/reporte/faltantes/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFaltantes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFaltantes(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processFaltantes(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IContenidoClient {
     ...
     * @return OK
     */
    modelos(usuarioId: string, tipo: string, archivo: string): Observable<void>;
    /**
     * @param uid (optional)
     * @param body (optional)
     * @return OK
...
export class ContenidoClient implements IContenidoClient {
     ...
     * @return OK
     */
    modelos(usuarioId: string, tipo: string, archivo: string, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/contenido/bucket/modelos/{usuarioId}/{tipo}/{archivo}";
        ...
        if (archivo === undefined || archivo === null)
            throw new Error("The parameter 'archivo' must be defined.");
        url_ = url_.replace("{archivo}", encodeURIComponent("" + archivo));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processModelos(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IListasClient {
    /**
     * @param miembros (optional)
     * @return OK
     */
    listasGet(miembros: boolean | undefined): Observable<ListaTalento[]>;
    /**
     * @param body (optional)
     * @return OK
     */
    listasPost(body: ListaTalentoInsertar | undefined): Observable<ListaTalento>;
    /**
     * @param body (optional)
     * @return OK
     */
    listasPut(id: string, body: ListaTalento | undefined): Observable<void>;
    /**
     * @return OK
     */
    listasDelete(id: string): Observable<void>;
    /**
     * @return OK
     */
    miembroPost(id: string, idpersona: string): Observable<void>;
    /**
     * @return OK
     */
    miembroDelete(id: string, idpersona: string): Observable<void>;
}

@Injectable({
    providedIn: 'root'
})
export class ListasClient implements IListasClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    listasGet(miembros: boolean | undefined, httpContext?: HttpContext): Observable<ListaTalento[]> {
        let url_ = this.baseUrl + "/api/Listas?";
        if (miembros === null)
            throw new Error("The parameter 'miembros' cannot be null.");
        else if (miembros !== undefined)
            url_ += "miembros=" + encodeURIComponent("" + miembros) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processListasGet(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processListasGet(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ListaTalento[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ListaTalento[]>;
        }));
    }

    protected processListasGet(response: HttpResponseBase): Observable<ListaTalento[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as ListaTalento[];
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListaTalento[]>(null as any);
    }
     ...
     * @return OK
     */
    listasPost(body: ListaTalentoInsertar | undefined, httpContext?: HttpContext): Observable<ListaTalento> {
        let url_ = this.baseUrl + "/api/Listas";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processListasPost(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processListasPost(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ListaTalento>;
                }
            } else
    ...
    protected processListasPost(response: HttpResponseBase): Observable<ListaTalento> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    listasPut(id: string, body: ListaTalento | undefined, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Listas/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processListasPut(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processListasPut(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processListasPut(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    listasDelete(id: string, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Listas/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processListasDelete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processListasDelete(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processListasDelete(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    miembroPost(id: string, idpersona: string, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Listas/{id}/miembro/{idpersona}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (idpersona === undefined || idpersona === null)
            throw new Error("The parameter 'idpersona' must be defined.");
        url_ = url_.replace("{idpersona}", encodeURIComponent("" + idpersona));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMiembroPost(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMiembroPost(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processMiembroPost(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    miembroDelete(id: string, idpersona: string, httpContext?: HttpContext): Observable<void> {
        let url_ = this.baseUrl + "/api/Listas/{id}/miembro/{idpersona}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMiembroDelete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMiembroDelete(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processMiembroDelete(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IPersonaClient {
     ...
     * @return OK
     */
    buscarPersonaCoincidencias(nombre: string | undefined): Observable<Persona[]>;
    /**
     * @param body (optional)
     * @return OK
     */
     ...
     * @return OK
     */
    inserta(texto: string | undefined): Observable<CatalogoBase>;
    /**
     * @param texto (optional)
     * @param clave (optional)
     * @return OK
     */
    actualiza(texto: string | undefined, clave: string | undefined): Observable<CatalogoBase>;
    /**
     * @param body (optional)
     * @return OK
     */
...
export class PersonaClient implements IPersonaClient {
     ...
     * @return OK
     */
    buscarPersonaCoincidencias(nombre: string | undefined, httpContext?: HttpContext): Observable<Persona[]> {
        let url_ = this.baseUrl + "/persona/BuscarPersonaCoincidencias?";
        if (nombre === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBuscarPersonaCoincidencias(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBuscarPersonaCoincidencias(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Persona[]>;
                }
            } else
    ...
    protected processBuscarPersonaCoincidencias(response: HttpResponseBase): Observable<Persona[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    inserta(texto: string | undefined, httpContext?: HttpContext): Observable<CatalogoBase> {
        let url_ = this.baseUrl + "/persona/agencia/inserta?";
        if (texto === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processInserta(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processInserta(response_ as any);
                } catch (e) {
    ...
    protected processInserta(response: HttpResponseBase): Observable<CatalogoBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    actualiza(texto: string | undefined, clave: string | undefined, httpContext?: HttpContext): Observable<CatalogoBase> {
        let url_ = this.baseUrl + "/persona/agencia/actualiza?";
        if (texto === null)
            throw new Error("The parameter 'texto' cannot be null.");
        else if (texto !== undefined)
            url_ += "texto=" + encodeURIComponent("" + texto) + "&";
        if (clave === null)
            throw new Error("The parameter 'clave' cannot be null.");
        else if (clave !== undefined)
            url_ += "clave=" + encodeURIComponent("" + clave) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processActualiza(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processActualiza(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CatalogoBase>;
                }
            } else
    ...
    protected processActualiza(response: HttpResponseBase): Observable<CatalogoBase> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface Casting {
    ...
    readonly deletedConflicts?: string[] | undefined;
    readonly localSequence?: number;
    readonly revisionsInfo?: RevisionInfo[] | undefined;
    revisions?: Revisions;
...
export interface CastingListElement {
    ...
    logoPromotora?: string | undefined;
}
...
export interface ListaTalentoInsertar {
    nombre?: string | undefined;
    clienteId?: string | undefined;
    agenciaId?: string | undefined;
    idPersonas?: string[] | undefined;
...
export interface Persona {
    ...
    idiomasIds?: string[] | undefined;
    agenciasIds?: string[] | undefined;
    nombreAgencia?: string | undefined;
...
export enum TipoLogoCasting {
    LogoCasting = "LogoCasting",
    LogoPromotora = "LogoPromotora",
}
