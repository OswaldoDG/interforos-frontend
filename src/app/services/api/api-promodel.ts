...
export interface ICastingClient {
     ...
     * @return Success
     */
    revisor(castingId: string, orden: string): Observable<SelectorCastingCategoria>;
    /**
     * @return Success
     */
...
export class CastingClient implements ICastingClient {
     ...
     * @return Success
     */
    revisor(castingId: string, orden: string, httpContext?: HttpContext): Observable<SelectorCastingCategoria> {
        let url_ = this.baseUrl + "/api/Casting/{CastingId}/selector/revisor/{orden}";
        if (castingId === undefined || castingId === null)
            throw new Error("The parameter 'castingId' must be defined.");
        url_ = url_.replace("{CastingId}", encodeURIComponent("" + castingId));
        if (orden === undefined || orden === null)
            throw new Error("The parameter 'orden' must be defined.");
        url_ = url_.replace("{orden}", encodeURIComponent("" + orden));
        url_ = url_.replace(/[?&]$/, "");
...
export interface IContenidoClient {
     ...
     * @return Success
     */
    documentacion(id: string | undefined, formFile: FileParameter | undefined, titulo: string | undefined, castingId: string | undefined): Observable<ElementoMediaCliente>;
    /**
     * @param id (optional) 
     * @param formFile (optional) 
     * @param titulo (optional) 
     ...
     * @return Success
     */
    carga(id: string | undefined, formFile: FileParameter | undefined, titulo: string | undefined, castingId: string | undefined): Observable<ElementoMediaCliente>;
}
...
export class ContenidoClient implements IContenidoClient {
     ...
     * @return Success
     */
    contenidoDelete(id: string, httpContext?: HttpContext): Observable<MediaCliente> {
     ...
     * @return Success
     */
    documentacion(id: string | undefined, formFile: FileParameter | undefined, titulo: string | undefined, castingId: string | undefined, httpContext?: HttpContext): Observable<ElementoMediaCliente> {
     ...
     * @return Success
     */
    carga(id: string | undefined, formFile: FileParameter | undefined, titulo: string | undefined, castingId: string | undefined, httpContext?: HttpContext): Observable<ElementoMediaCliente> {
...
export interface ModeloCasting {
    ...
    calificacionCalculada?: number;
    comentarios?: ComentarioCasting[] | undefined;
    votos?: VotoModeloCategoria[] | undefined;
}

export interface ModeloOrdenable {
    id?: string | undefined;
    rev?: string | undefined;
    readonly deleted?: boolean;
    readonly conflicts?: string[] | undefined;
...
export interface SelectorCategoria {
    id?: string | undefined;
    nombre?: string | undefined;
    modelos?: ModeloOrdenable[] | undefined;
